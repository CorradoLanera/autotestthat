# Getting help with autotestthat

Thanks for using autotestthat. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/autotestthat/issues) to make sure the 
